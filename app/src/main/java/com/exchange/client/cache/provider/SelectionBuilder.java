 ...
 * classes : com.sohu.sohuvideo.provider.SelectionBuilder
 * @author xiangyutian
 * V 1.0.0
 * Create at 2014-4-15 下午4:49:12
 */
...
/**
 * com.sohu.sohuvideo.provider.SelectionBuilder
 * 
...
public class SelectionBuilder {
    ...
    public Cursor query(SQLiteDatabase db, String[] columns, String groupBy, String having, String orderBy, String limit) {
        ...
        if (columns != null)
            mapColumns(columns);
        LogUtils.d(TAG, "query(columns=" + Arrays.toString(columns) + ") " + this);
