...
/**
 * com.exchange.client.widget.PullToRefreshBase
 * 
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
    ...
    // private IOnPullDownListener mRankAndSearchListener;
    ...
    public void setCircleProgress(int progress) {
        if (null != headerLayout) {
            headerLayout.setCircleProgress(progress);
        }
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_pull_mode)) {
            mode = a.getInteger(R.styleable.PullToRefresh_pull_mode, MODE_PULL_DOWN_TO_REFRESH);
        }
        ...
        String pullLabel = context.getString(R.string.hint_pull_to_refresh);
        String refreshingLabel = context.getString(R.string.hint_loading);
        String releaseLabel = context.getString(R.string.hint_release_to_refresh);
        // pull_to_refresh_last_uplaod_time
        // Add Loading Views
        ...
        // Styleables from XML
        if (a.hasValue(R.styleable.PullToRefresh_pull_headerTextColor)) {
            final int color = a.getColor(R.styleable.PullToRefresh_pull_headerTextColor, Color.BLACK);
            if (null != headerLayout) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_pull_headerBackground)) {
            this.setBackgroundResource(a.getResourceId(R.styleable.PullToRefresh_pull_headerBackground, Color.WHITE));
        }
        if (a.hasValue(R.styleable.PullToRefresh_pull_adapterViewBackground)) {
            refreshableView.setBackgroundResource(a.getResourceId(R.styleable.PullToRefresh_pull_adapterViewBackground,
                    Color.WHITE));
        }
        a.recycle();
    ...
    private boolean pullEvent() {
        ...
        setCircleProgress(Math.abs(newHeight) * 100 / headerHeight);
        if (newHeight != 0) {
